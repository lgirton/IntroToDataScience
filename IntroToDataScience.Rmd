...
I had observed that there were predictions made by this model that were negative and in these cases these would not be good estimates, as there is no such things as _negative_ entries and might not be the best model.  The model did perform better than the naïve approach of using the mean as the prediction and so I would certainly select this model over the naïve approach.
